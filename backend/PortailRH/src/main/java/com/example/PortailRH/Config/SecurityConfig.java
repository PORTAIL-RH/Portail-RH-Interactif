    ...
    public org.springframework.security.web.DefaultSecurityFilterChain securityFilterChain(HttpSecurity http, WebConfig webConfig) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/Personnel/reset-password-mobile").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/Personnel/request-password-reset-mobile").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/Personnel/validate-reset-token-mobile").permitAll()
