...
@Document("Response_chefs_dem_formation")

public class Response_chefs_dem_formation {
    ...
    public Response_chefs_dem_formation() {
    }

    public Response_chefs_dem_formation(String responseChef1, String observationChef1, String dateChef1,
