      ...
      <ul className="sidebar-links">
        ...
        <li className="sidebar-item">
          ...
          <ul className={`dropdown-menu ${isDemandesOpen ? "open" : ""}`}>
            <li className="dropdown-item">
              <Link to="/FormationRH" className="dropdown-link">Formation</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/AutorisationRH" className="dropdown-link">Autorisation</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/PreAvanceRH" className="dropdown-link">Pre-Avance</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/DocumentRH" className="dropdown-link">Document</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/CongeRH" className="dropdown-link">Conge</Link>
            </li>
          </ul>
        </li>
        ...
        <li className="sidebar-item">
          ...
          <ul className={`dropdown-menu ${isProfilOpen ? "open" : ""}`}>
            <li className="dropdown-item">
              <Link to="/ProfileRH" className="dropdown-link">Profil</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/DemandesRH" className="dropdown-link">Mes demandes</Link>
            </li>
            <li className="dropdown-item">
              <Link to="/AjoutDemandeAutorisationRH" className="dropdown-link">Ajout-demande</Link>
            </li>
